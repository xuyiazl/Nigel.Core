...
namespace Nigel.Webs
{
    ...
    public static class CookieHelper
    {
        ...
        public static string GetCookie(string name) => GetCookie(Nigel.Helpers.Web.HttpContext, name);
        ...
        public static void WriteCookie(string name, string value) =>
            WriteCookie(Nigel.Helpers.Web.HttpContext, name, value);
        ...
        /// 清空 Cookie
        /// </summary>
        public static void ClearCookie() => ClearCookie(Nigel.Helpers.Web.HttpContext);
